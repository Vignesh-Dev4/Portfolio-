...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        {
            name: 'Email',
            url: 'mailto:vigneshsivaji8@gmail.com',
            icon: (
        ...
        <footer className="relative bg-dark-900/50 border-t border-dark-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map((link) => (
                                <li key={link.name}>
                                    <a
                                        href={link.href}
                                        className="text-dark-400 hover:text-primary-400 transition-colors duration-300 animated-underline inline-block"
                                    >
                                        {link.name}
                                    </a>
                                </li>
                    ...
                    {/* Social Links */}
                    <div className="space-y-4">
                        <h4 className="text-lg font-semibold text-dark-50">Connect</h4>
                ...
                <div className="pt-8 border-t border-dark-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <p className="text-dark-400 text-sm">
                            Built with <span className="text-primary-400">React</span> & <span className="text-accent-400">Tailwind CSS</span>
                        </p>
                    </div>
                </div>
            </div>
